...
The two notes address logically distinct questions and should not be conflated.
  ...
  \section{Constituent Papers}
    ...
    \subsection{Capacity axiom and Born--Infeld candidate: BornInfeld}
      ...
      candidate action feeds the O-series pair observable through O18.
  ...
  \section{Inputs from Upstream Results}
    ...
    \begin{enumerate}
      ...
      structure of the Born--Infeld candidate action, implemented in the Weil setting by
      O18, supplies the minimal fibre condition used by the O-series pair observable.
    \end{enumerate}
